...
import {deleteItem} from './Swipablelist'
...
export default function ({ selecteditem, hide_model, edit, deleteItem, delete_model }) {
...
const {delete_reminder } = useContext(Context);
  ...
  return (
    ...
    >
      ...
      >
        Select a date or time in the future
      </Snackbar>
    </View>
  );
}
